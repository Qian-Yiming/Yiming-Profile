...
| **Sex difference Project**| [x]|[x]||||||||
| **Child maltreatment Project**| [x]||[x]|[x]|[x]|||||
| **AF Project**| [x]||[x]|[x]||[x]||||
...
- Agenda: 
    - Master thesis
    - talked about the health condition and roommate issue yesterday
    - submit the IRB again and create a new study in SONA
    - Child health study monthly meeting
- To do:
    - Paper or coding next week
    - get two specfic time slots for writing and reading

### 2019 Sept 26 12:30PM
- length: 90 min 
- location: Moore 114
- Agenda: 
    - read a child maltreatment paper, and monthly meeting
    - master thesis, such as Liz, Johnnason Cook, Adam
    - First year project will be presented in lab meeting on Oct 10
