---
title: "Mentor_Meeting_2018-2019"
author: "Yiming"
date: "`r Sys.Date()`"
...
- length: 60 min 
- location: HHD 209
- Attendant: Jenn Nolls, Rick Gilmore, Giorgia Picci, Emma Rose
- Agenda: 
    - What can I contribute to the team?
        - My prior analysis in DTI is benefical to the team
        - help with data collection 
        - my expertise in data cleaning in R can facilitate the coding process
        - new grant: a subset of kids to do additional perceptual tasks
        - I am a student in Psychology and I also have experience teaching and working with children in day care center, summmer camp, and especially children who experienced dometic violence. 
        - my training in vision science. 
    - how does this research contribute to my research?
        - build my research statement (visual perception in maltreated children and with developmental disorders, if I want to keep doing it)
        - data collection experience in MRI imaging, as well as in maltreated children
        - close to child maltreatment. This project is the biggest project in child maltreatment
        - supervise undergraduates
        - some visual acuity tasks currently (little findings has been found)
    - process: 
        - give a paragraph to Giorgia of my interest and how it align (faculties can see its value). I can also ask Rick and Giorgia for revision
        - the ream will discuss my case in the next week meeting
        - Time commitment
        - IRB
        - training (biochemical, MRI training ...)
    - Pros (discussion with Rick)
        - research in maltreatment
        - salary
        - possible two year fellowship
        - salaries in summer
        - data collection and neuroimaging collection
        - the biggest dataset in child maltreatment
    - Cons (discussion with Rick)
        - time commitment
        - two lines of research?
        - postpone the sex difference project
        - learn a new set of data collection
    
    Rick Said "you can be expert in visual perception in maltreated children and with developmental disorders. This is the area not many researchers are on it"
    "I will support you if you think it is the right path for you."
    "If you really interested in this, you need to commit to it"
- To do:
    - send the paragraph
...
- length: 30 min 
- location: BBH 3
- Attendants: Giorgia Pi, Emma Rose
- Agenda: 
   - know more about the data
   - what do I want to do?
   - Giorgia sent me some visual perception articles to read
   - arrange a meeting with Giorgia, Emma and Rick
   
***
## Meetings with Rick and sheri

For the Summer 2019, I will meet Rick and sheri on Tuesday in Rick's office.

# 2019 Aug 13 Tue
- length: 60 min
- location: Moore 114
- Agenda: 
     - protocal ASAP, ask Andrea and Rick for help
     - the parameters in the study
     - Sheri said "You have done a great job"
     - study can be conducted before the approval of protocol, "but not better not after Nov you still have not submitted it"
- to do:
     - numerical ability
     - is there sex difference in biological motion?
     
# 2019 Jul 30 Tue
- length: 90 min
- location: Moore 114
- Agenda: 
     - two behavioral tests you are going to do and questionnaires
     - exempt or not?
     - subject pool: number of participants, hours, how to balance male and female
...
- location: Moore 114
- Agenda: 
     - thesis "I can be with you to talk with Jenae"
        - the problem is which project
     - we also worked on the consent form and finish it
